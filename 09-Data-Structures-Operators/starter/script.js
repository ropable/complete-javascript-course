...
*/
for (const [idx, name] of game.scored.entries()) console.log(`Goal ${idx + 1}: ${name}`);
...
for (let [team, odds] of Object.entries(game.odds)) {
  team = game[team] ? `victory ${game[team]}` : 'draw';
  console.log(`Odds of ${team}: ${odds}`);
}
